...
sed -i 's/ImmortalWrt/JD_Cloud/g' package/base-files/files/bin/config_generate
...
wget --no-check-certificate -O package/base-files/files/etc/banner "https://raw.githubusercontent.com/0xACE8/laoliuonly/main/jdcloud_re-cp-03/banner"
...
wget --no-check-certificate -O package/base-files/files/etc/uci-defaults/zzz-updata-settings "https://raw.githubusercontent.com/0xACE8/laoliuonly/main/jdcloud_re-cp-03/zzz-updata-settings"
